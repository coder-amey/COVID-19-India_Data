...
updated_tally = updated_tally.rename(columns = {"Name of State / UT": "Region", "Total Confirmed cases (Including foreign Nationals)": "Confirmed", "Cured/Discharged/Migrated": "Recovered/Migrated", "Deaths ( more than 70% cases due to comorbidities )": "Deceased"})
