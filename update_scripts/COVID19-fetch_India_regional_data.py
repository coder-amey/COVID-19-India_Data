...
updated_tally = updated_tally.rename(columns = {"Name of State / UT": "Region", "Total Confirmed cases (Including 76 foreign Nationals)": "Confirmed", "Cured/Discharged/Migrated": "Recovered/Migrated", "Death": "Deceased"})
...
#Correct the spelling errors in the table.
updated_tally.loc[updated_tally.Region == "Telengana", "Region"] = "Telangana"
updated_tally.loc[updated_tally.Region == "Nagaland#", "Region"] = "Nagaland"
