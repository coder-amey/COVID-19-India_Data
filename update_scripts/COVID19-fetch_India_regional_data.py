...
updated_tally = updated_tally.rename(columns = {"Name of State / UT": "Region", "Total Confirmed cases (Including 111 foreign Nationals)": "Confirmed", "Cured/Discharged/Migrated": "Recovered/Migrated", "Deaths ( more than 70% cases due to comorbidities )": "Deceased"})
...
updated_tally.loc[updated_tally.Region == "Dadar Nagar Haveli", "Region"] = "Dadra and Nagar Haveli"		#Correct the spelling of Telangana.
