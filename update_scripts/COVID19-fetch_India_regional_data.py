...
updated_tally = updated_tally.rename(columns = {"Name of State / UT": "Region", "Total Confirmed cases (Including 77 foreign Nationals)": "Confirmed", "Cured/Discharged/Migrated": "Recovered/Migrated", "Death": "Deceased"})
...
updated_tally = updated_tally[updated_tally.Region != "Nagaland"]		#Discard the entry of Nagaland with '0' cases.
