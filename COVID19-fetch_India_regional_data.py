...
updated_tally = updated_tally.rename(columns = {"Name of State / UT": "Region", "Total Confirmed cases *": "Confirmed", "Cured/Discharged/Migrated": "Recovered/Migrated", "Death": "Deceased"})
